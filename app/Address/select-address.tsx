      ...
      <View className="flex-1">
        ...
        >
          ...
          >
            ...
            <View className="ml-3">
              <Text className="font-semibold text-xs">Use my current location</Text>
              <Text className="text-gray-500 mt-1 text-xxs">Allow access to location</Text>
            </View>
          </TouchableOpacity>
              ...
              >
                <View className="flex-row justify-between items-start mb-2">
                  <View className="flex-row items-center">
                    ...
                    <Text className="ml-3 font-bold text-base">Karthik Kumar</Text>
                  </View>
